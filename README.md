...
.env ファイルに、自動的に DATABASE_URL が記載される
...
- DATABASE_URL : Transaction + Password + "?pgbouncer=true&connection_limit=1"
  Supabase の場合は、Connect から Mode を Transaction にして表示されるものをコピペ
  Password は、Supabase でプロジェクトを作った時に設定したものを Transaction 内の所定の場所に入れ込む
  最後の文字列は、Transaction の後ろに追加する

- DIRECT_URL : Session + Password
  同じく Supabase の場合、今度は Mode を Session に変えてコピペ

下記は、shcema.prisma にデフォルトで記載されてるものを消して上書きする
